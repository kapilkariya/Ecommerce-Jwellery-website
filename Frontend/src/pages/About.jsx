      ...
      <div className='my-10 w-[95vw] sm:w-[70vw] md:w-[100vw] m-auto'>
        ...
        <div className="w-full max-w-6xl mx-auto p-8 bg-white flex flex-col md:flex-row items-start gap-10">
          ...
          <div className=" my-auto lg:w-3/5 w-full text-gray-600 font-sans leading-relaxed">
            <p className="mb-4 text-sm lg:text-base">UniFinds was born from a passion for discovering unique products and a vision to make online shopping simple, stylish, and enjoyable. Our journey started with one clear goal: to create a platform where people can effortlessly explore and find products that truly stand out..</p>
            <p className="mb-6 text-sm lg:text-base">From the very beginning, we’ve focused on curating a thoughtfully selected range of high-quality items that blend trend, quality, and value. Whether it’s fashion, accessories, lifestyle essentials, or everyday must-haves, UniFinds brings together products that reflect individuality and modern taste, all sourced from reliable and trusted partners.</p>
            <h3 className=" text-lg lg:text-xl font-bold  mt-6 mb-3">Our Mission</h3>
            <p className=" text-sm lg:text-base">At UniFinds, our mission is to make discovering great products easy and inspiring. We aim to offer convenience, reliability, and confidence at every step of the shopping journey — from browsing and selection to checkout and delivery. We believe shopping should feel effortless, enjoyable, and personal.</p>
          </div>
        </div>
        <div className="w-full max-w-6xl mb-10 mx-auto py-12 px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-4 border-l border-gray-200">
            ...
            <p className="text-sm lg:text-base text-gray-700 leading-relaxed">Our dedicated support team is always here to guide you at every step, ensuring your experience with UniFinds is seamless, reassuring, and truly satisfying.</p>
          </div>
        </div>
        <NewsLetterBox/>
      </div>
