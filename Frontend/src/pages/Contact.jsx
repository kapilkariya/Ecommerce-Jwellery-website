          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="https://www.instagram.com/unifindshub?igsh=cnNlN25reWxqZHFw" target="_blank" rel="noopener noreferrer" className="text-lg text-gray-900 hover:text-pink-600 transition-colors">
                  @UniFindHub
                </a>
